/**************************************************************************
 * DrinknomoreApplicationBase.java, drinknomore Android
 *
 * Copyright 2014
 * Description : 
 * Author(s)   : Harmony
 ...
 * Harmony.
 * You should edit DrinknomoreApplication class instead of this
 * one or you will lose all your modifications.</i></b>
 *
 */
public abstract class DrinknomoreApplicationBase
    extends Application {

    /** TAG for debug purpose. */
    protected static final String TAG = "DrinknomoreApplication";
    /** Singleton. */
    private static volatile DrinknomoreApplicationBase singleton;
    /** Date format. */
     ...
     */
    private static void setSingleton(DrinknomoreApplicationBase application) {
        if (singleton == null) {
     ...
     */
    public static DrinknomoreApplicationBase getApplication() {
        return singleton;
    }
    ...
    public static String getVersion(final android.content.Context ctx) {
        final SharedPreferences settings = ctx.getSharedPreferences(
                DrinknomoreApplicationBase.PREFS_PUBL,
                android.content.Context.MODE_WORLD_READABLE);

        return settings.getString(
                DrinknomoreApplicationBase.PREFS_VERS, "");
    }
