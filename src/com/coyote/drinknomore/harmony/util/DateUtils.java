/**************************************************************************
 * DateUtils.java, drinknomore Android
 *
 * Copyright 2014
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.coyote.drinknomore.harmony.util;
...
public class DateUtils extends android.text.format.DateUtils {
    ...
    public static String formatDateToString(DateTime date, boolean local) {
        java.text.DateFormat df = DrinknomoreApplication.getDateFormat();
    ...
    public static String formatTimeToString(DateTime time) {
        String result = null;
        if (DrinknomoreApplication.is24Hour()) {
    ...
    public static DateTime formatStringToDate(String date) {
        return formatStringToDateTime(DrinknomoreApplication
                            .getDateFormat(), date);
    }
