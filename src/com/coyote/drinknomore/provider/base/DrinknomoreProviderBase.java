/**************************************************************************
 * DrinknomoreProviderBase.java, drinknomore Android
 *
 * Copyright 2015
 * Description : 
 * Author(s)   : Harmony
...
/**
 * DrinknomoreProviderBase.
 */
public class DrinknomoreProviderBase extends ContentProvider {
    /** TAG for debug purpose. */
    protected static String TAG = "DrinknomoreProvider";
    /** Uri not supported. */
    protected static String URI_NOT_SUPPORTED;

    /* Tools / Common. */
    /** com.coyote.drinknomore.provider authority. */
    ...
    public boolean onCreate() {
        ...
        ReponsesProviderAdapter reponsesProviderAdapter =
            new ReponsesProviderAdapter(this);
        this.db = reponsesProviderAdapter.getDb();            
        this.providerAdapters.add(reponsesProviderAdapter);
        this.providerAdapters.add(
                new QuestionsProviderAdapter(this));
        this.providerAdapters.add(
                new StatistiquesProviderAdapter(this));
