/**************************************************************************
 * SQLiteAdapterBase.java, drinknomore Android
 *
 * Copyright 2015
 * Description : 
 * Author(s)   : Harmony
...
public abstract class SQLiteAdapterBase<T> {
    ...
    public static final String TAG = "DrinknomoreSQLiteAdapterBase";
     ...
     * Open Helper.
     */
    protected DrinknomoreSQLiteOpenHelper mBaseHelper;
    ...
    protected SQLiteAdapterBase(final android.content.Context ctx) {
        this.ctx = ctx;
        this.mBaseHelper = new DrinknomoreSQLiteOpenHelper(
                ctx,
                DB_NAME,
                null,
                DrinknomoreApplication.getVersionCode(ctx));
